...
class DecisionHandler {
  static void handleDecision(
      ...
      String selectedFood,
      String selectedSpor) {
    if ((selectedBudget == 'Çok bütçem var.' || selectedBudget == 'Bütçeyi düşünmüyorum. Para böyle yenir.' || selectedBudget == 'Biraz bütçem var.') &&
        selectedMeaning == 'Eğlence' &&
        (selectedFood != 'Sushi' && selectedFood != 'Pizza') &&
      ...
      Navigator.push(
        ...
        MaterialPageRoute(builder: (context) => AmerikaPage()),
            ...
            selectedAgeGroup == '50 üstü' &&
            selectedMeaning == 'Sakinlik' &&
            selectedSpor != 'yoga' &&
            (selectedFood != 'Pizza' && selectedFood != 'Sushi')) ||
    ...
    } else if (((selectedBudget == 'Çok bütçem var.' || selectedBudget == 'Bütçeyi düşünmüyorum. Para böyle yenir.' || selectedBudget == 'Biraz bütçem var.') && selectedMeaning == 'Mimari' && selectedFood == 'Pizza') ||
        ((selectedBudget == 'Çok bütçem var.' || selectedBudget == 'Bütçeyi düşünmüyorum. Para böyle yenir.' || selectedBudget == 'Biraz bütçem var.') &&
            selectedMeaning == 'Mimari' &&
            selectedFood == 'Hamburger') ||
        ((selectedBudget == 'Çok bütçem var.' || selectedBudget == 'Bütçeyi düşünmüyorum. Para böyle yenir.' || selectedBudget == 'Biraz bütçem var.') &&
            selectedMeaning == 'Mimari' &&
            selectedFood == 'Kebap') ||
        ((selectedBudget == 'Çok bütçem var.' || selectedBudget == 'Bütçeyi düşünmüyorum. Para böyle yenir.' || selectedBudget == 'Biraz bütçem var.') &&
            selectedFood == 'Pizza' &&
            selectedMeaning == 'Tarih')) {
      Navigator.push(
        context,
    ...
    } else if (((selectedBudget == 'Çok bütçem var.' || selectedBudget == 'Bütçeyi düşünmüyorum. Para böyle yenir.') && selectedMeaning == 'Eğlence' && selectedTransport == 'Araba' && selectedFood == 'Sushi') ||
      ...
      Navigator.push(
        ...
        MaterialPageRoute(builder: (context) => JapanPage()),
            ...
            selectedSeason != 'yaz' &&
            (selectedFood != 'Pizza' && selectedFood != 'Sushi') &&
            (selectedSpor != 'yoga' && selectedSpor != 'yüzme') ||
        ((selectedBudget == 'Bütçeyi düşünmüyorum. Para böyle yenir.' || selectedBudget == 'Çok bütçem var.') &&
            selectedSpor == 'kayak' &&
            selectedSeason != 'kış' &&
            selectedMeaning == 'Sakinlik' &&
            (selectedFood != 'Pizza' && selectedFood != 'Sushi') &&
      ...
      Navigator.push(
        ...
        selectedMeaning == 'Tarih' &&
        (selectedSpor != 'yüzme' && selectedSpor != 'yoga') &&
        (selectedFood != 'Pizza' && selectedFood != 'Sushi')) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => IngilterePage()),
      );
    } else if ((selectedBudget == 'Biraz bütçem var.' &&
            (selectedMeaning == 'Tarih' || selectedMeaning == 'Eğlence') &&
            (selectedFood != 'Pizza' && selectedFood != 'Sushi') &&
            (selectedSpor != 'yoga' && selectedSpor != 'kayak')) ||
        ((selectedBudget == 'Biraz bütçem var.' || selectedBudget == 'Çok bütçem var.') && selectedMeaning == 'Tarih' && selectedSpor == 'yüzme')) {
      Navigator.push(
        context,
