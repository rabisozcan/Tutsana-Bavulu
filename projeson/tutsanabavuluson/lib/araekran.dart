              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'TutSanaBavulu\'nda keşfe hazır mısınız? Çark çevirerek yeni yerler keşfedebilir veya test çözerek bilgilerinizi sınayabilirsiniz. Maceranız şimdi başlasın!',
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  HolidayPollApp()), // Replace SecondScreen with the actual screen you want to navigate to
                        );
                      },
                      child: Container(
                        margin: EdgeInsets.only(bottom: 250),
