...
import 'ingiltereyemekler.dart';
import 'ingilteregezilecekyerler.dart';
import 'ingilteregecehayati.dart';
import 'ingiltereulasim.dart';
      ...
      onTap: () {
        ...
        switch (index) {
          ...
          case 2:
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => IngiltereGeceHayati()),
            );
            break;
          case 3:
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => IngiltereUlasim()),
            );
            break;
          default:
            break;
